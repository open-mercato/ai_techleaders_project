...
Document type: the founders' assignment of who does what, made on the board on 2026-09-05. It replaces the reading in `2026-09-04-miro-board-stakeholders.md` that the frame carried no R/A/C/I. Roles, not people: today the sponsor, product owner and UX/UI columns are founder A and the project manager, tech lead and developer columns are founder B. QA and legal have no person behind them yet.
...
- Finance is on the stakeholder list and not on the matrix. Payment and commission has legal as C; whoever settles payouts and refunds (the operator) has no column.
