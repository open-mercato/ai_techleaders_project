...
| 1 | 1.1 | Add exact money primitives and session-length vocabulary | dispatch:standard | todo | — |
| 1 | 1.2 | Add approved platform price configuration and settings service | dispatch:capable | todo | — |
