...
| --- | --- | --- | --- | --- | --- |
| 0 Umbrella | 0.1 | Spec + run folder on the umbrella branch | inline | done | — |
| 1 Design system | 1.1 | `SessionComposer` component, CSS, unit tests, export | inline | todo | — |
...
| --- | --- | --- | --- | --- | --- |
| U | _pending_ (umbrella) | `feat/e04-s01-text-session` | `feat/epic-03-booking-and-payment` | 0.1 | Read the spec; this table is the status board |
