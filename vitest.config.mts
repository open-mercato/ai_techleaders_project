  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'packages/app/src/app/api/sessions/booking-id.ts',
        'packages/app/src/app/api/sessions/\\[bookingId\\]/route.ts',
        'packages/app/src/app/api/sessions/\\[bookingId\\]/messages/route.ts',
        ...
        'packages/core/src/services/payments/payment.service.ts',
        'packages/core/src/services/payments/payout.service.ts',
        'packages/core/src/services/payments/adapters/mock-payment-gateway.ts',
        'packages/core/src/services/payments/adapters/stripe-payment-gateway.ts',
        ...
        'packages/db/src/entities/bookings/booking-status.ts',
        ...
        'packages/db/migrations/Migration20260910185543_mentor_prices.ts',
